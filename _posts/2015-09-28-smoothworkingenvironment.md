...
I switched from MATLAB to Python earlier this year and was surprised by how similar the languages are. If you decide to work with Python locally, I (and [this](http://www.ccrc.unsw.edu.au/ccrc-team/students/ned-haughton) guy and [this](https://twitter.com/drclimate) guy) recommend downloading the [Anaconda](https://www.anaconda.com/products/individual) distribution by Continuum Analytics. If you need help getting started with Python (as a climate scientist) read [this](https://drclimate.wordpress.com/2013/10/03/getting-started-with-python/). If you need help plotting data on a map see [this](http://matplotlib.org/basemap/users/examples.html).
